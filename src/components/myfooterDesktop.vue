<template>
    <div class="footerDesktop">
        <div class="footerWrapper">
            <div class="price">
                <div class="pricespdf">
                    <h6>х сделано руками х</h6>

                    <a href="./files/tsement-2022.pdf" target="_blank">
                        <u>прайс-лист плитка (pdf)</u>
                        <br />
                    </a>
                    <a href="./files/breeze-block-2022.pdf" target="_blank">
                        <u>прайс-лист бриз-блок (pdf)</u>
                    </a>
                </div>
            </div>
            <div class="main">
                <div>
                    ...
                    <ul>
                        <li>
                            <router-link to="/tile"> плитка </router-link>
                        </li>
                        <li>
                            <router-link to="/breeze-block">
                                бриз-блок
                            </router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/palette"> палитра </router-link>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="info">
                ...
                <h6 class="connect">Связь</h6>
                <ul class="numbers">
                    <li>
                        <a href="tel:+7 342 298–86–57"> +7 342 298–86–57</a>
                    </li>
                    <li>
                        <a href="tel:+7 902 472–86–57 "> +7 902 472–86–57</a>
                    </li>
                </ul>
                <div class="footerSocials">
                    <ul>
                        <li>
                            <a href="https://wa.me/79024728657" target="_blank">
                                <img
                                    class="wu"
                                    src="@/assets/img/Whatsup.svg"
                                    alt="Whatsup"
                            /></a>
                        </li>
                        <li>
                            <a href="https://t.me/cemtiles" target="_blank"
                                ><img
                                    class="tg"
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/kamennaya_manufaktura/"
                                target="_blank"
                            >
                                <img
                                    class="inst"
                        ...
                        <li>
                            <a
                                href="https://ru.pinterest.com/kamennaya_manufaktura/"
                                target="_blank"
                            >
                                <img
                                    class="pt"
        ...
        <div class="footerSection">
            ...
            <div class="address">
                <a
                    href="https://yandex.ru/maps/50/perm/house/promyshlennaya_ulitsa_63_1/YU8YdwRhSUwBQFttfXV1eX5mYQ==/?ll=56.129709%2C57.948571&z=17.23"
                    target="_blank"
                >
                    г. пермь <br />
                    ул. промышленная 63/1
                </a>
                <button
                    class="copy"
                    v-clipboard:copy="'г. Пермь, ул. Промышленная 63/1'"
                >
                    Копировать в буфер
                </button>
            </div>
...
.footerDesktop {
    .footerSection {
        ...
        display: grid;
        grid-template-columns: 850rem 860rem;
    ...
    .footerWrapper {
        ...
        display: grid;
        grid-template-columns: 850rem 430rem 430rem;
        grid-template-rows: 860rem;
        p {
            text-decoration: none;
            font-size: 18rem;
            line-height: 167%;
                    ...
                    li {
                        a {
                            img {
                                width: 40rem;
                                height: 40rem;
                                cursor: url("@/assets/img/cursorHover.svg"),
                                    auto;
                            }
                        }
                    }
